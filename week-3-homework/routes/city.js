...
router.get('/', async (req, res) => {
  ...
  try {
    ...
    res.send({ "cityList": result, "tableTitle": "List of world cities" });
...
router.get('/submit-search-form-get', async function (request, response) {
  ...
  response.send({ "cityList": cityList, "tableTitle": "Filtered cities" });
...
router.get('/id/:id', async (req, res) => {
  try {
    ...
    res.send({ "city": city[0], "title": "Detail page" });
  } catch (e) {
...
router.post('/submit-add-city-form-with-post', async function (request, response) {
  ...
  console.log('Created ' + insertedValues.affectedRows + ' rows');
...
router.post('/submit-edit-form-with-post', async function (request, response) {
...
router.get('/madridcities', async (req, res) => {
  try {
